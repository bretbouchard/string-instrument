...
add_library(AetherDSP STATIC ${KANE_MARCO_AETHER_SOURCES})
...
target_link_libraries(KaneMarcoAetherFFI PUBLIC AetherDSP)

# Tests
add_executable(KaneMarcoAetherTests ${KANE_MARCO_AETHER_TESTS})
target_link_libraries(KaneMarcoAetherTests PRIVATE AetherDSP JUCE::juce_recommended_config_files JUCE::juce_recommended_lto_flags)
```
